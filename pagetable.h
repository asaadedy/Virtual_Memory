...
struct frame {
    ...
    addr_t virt_addr;   // Additional field that makes it easier to check vaddr
    // we assume that the vaddr that is stored in the frame is only for 
    // debugging, and not the usage in the program
};
